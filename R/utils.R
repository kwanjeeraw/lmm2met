...
#rmarkdown::render("vignettes/limmo_vignette.Rmd", output_format="all")
#rmarkdown::render("vignettes/limmo_vignette.Rmd", output_format="word_document")
#rmarkdown::render("vignettes/limmo_vignette.Rmd", output_format="pdf_document")
