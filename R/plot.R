#' @title Plot \code{limmo} object
#' @name plot.limmo
#' @description plot \code{limmo} object.
#' @usage plot.limmo(x, type, fix, ...)
#' @param x \code{limmo} object from \code{fitLmm}
...
#' @export
plot.limmo <- function(x, type, fix=NULL, ...) {
